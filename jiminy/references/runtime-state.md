...
3. Create directories with mode `0700` and the log with mode `0600`. Record task IDs, issue/PR mapping, head SHAs, current and resume nodes, review/fix cycle counts, gate changes, blockers, nudges, authority, post-merge integration results, and verified results. Never record secrets.
