...
4. Register the continuation with `python3 "${CODEX_HOME:-$HOME/.codex}/skills/gepetto/../hooks/orchestration_state.py" continue --source-id <source-id> --successor-id <successor-id>`.
