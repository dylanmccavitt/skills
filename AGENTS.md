...
- Flag state transitions that bypass the registry lock, atomic replacement, or checkpoint recovery path. Safe path: route mutations through `voice_state.py` primitives and prove conflicts plus recovery in tests.
